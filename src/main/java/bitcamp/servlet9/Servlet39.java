 ...
 * => HttpSession 객체를 사용하려 할 때 해당 객체가 없으면,
 ...
 * => 웹서버가 웹브라우저에게 쿠키로 내려보낸 세션 아이디
 * => 새로 HttpSession 객체를 만드는 경우,
 *    웹서버는 웹브라우저에게 쿠키로 세션 아이디를 내려보낸다.
 * 
...
-------------------
GET /web01/servlet/servlet39 HTTP/1.1
Host: localhost:8080
...
Set-Cookie: JSESSIONID=D561E55E4E0169A4DC83C041985A2B86; Path=/web01; HttpOnly
Content-Type: text/plain;charset=UTF-8
Content-Length: 79
Date: Fri, 23 Dec 2016 07:02:24 GMT
-------------------------- 
 * 
 */
...
Accept-Encoding: gzip, deflate, sdch, br
Accept-Language: ko-KR,ko;q=0.8,en-US;q=0.6,en;q=0.4
Cookie: JSESSIONID=D561E55E4E0169A4DC83C041985A2B86
--------------------
 * 
 * 기존 HttpSession 객체를 사용하는 경우에는 
...
Content-Type: text/plain;charset=UTF-8
Content-Length: 79
Date: Fri, 23 Dec 2016 07:06:10 GMT
-------------------------- 
 * 
 */