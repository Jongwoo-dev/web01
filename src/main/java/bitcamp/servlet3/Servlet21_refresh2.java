/* 주제: HttpServletResponse 사용 - 페이지 이동 기법 II
 * => HTTP 프로토콜의 응답을 다루는 기능이 들어 있다.
 * => Refresh
...
public class Servlet21_refresh2 extends GenericServlet {
  ...
  public void service(ServletRequest req, ServletResponse resp) 
    ...
    out.println("<title>servlet21_refresh2</title>");
    out.println("</head>");
    out.println("<body>");
...
Refresh: 5;url=http://www.daum.net
Content-Type: text/html;charset=UTF-8
Content-Length: 180
Date: Mon, 12 Dec 2016 02:48:46 GMT
