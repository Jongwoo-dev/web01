/* 주제: HttpServletResponse 사용 - 페이지 이동 기법 III
...
public class Servlet21_redirect extends GenericServlet {
  ...
  public void service(ServletRequest req, ServletResponse resp) 
    ...
    out.println("<title>servlet21_redirect</title>");
    out.println("</head>");
    out.println("<body>");
    // 버퍼를 꽉 채워 자동으로 출력하게 해서 sendRedirect()를 못하게 테스트 하고 싶다면
