 ...
 * => Servlet 은 작은 서버 프로그램을 작은 조각으로 개발할 수 있게 도와주는 기술이다.
 ...
 *    최소한의 응답 정보를 다루는 ServletResponse로 정의 하였다.
 * => 그러나 "서블릿 + 웹"으로 사용한다면,
 *    service()메서드에 실제 전달되는 파라미터 값은,
 *    HTTP 요청 정보를 다룰 수 있는 HttpServlerRequest와
...
public class Servlet19 extends GenericServlet {
  ...
  public void service(ServletRequest request, ServletResponse response) 
    ...
    out.println("</head>");
    out.println("<body>");
    out.println("<h1>HttpServletRequest와 HttpServletResponsee</h1>");
