 ...
 * 1) 사용자가 입력한 문자열    
 *    => "ABC0123가각간"
 * 2) 웹 브라우저가 웹서버에게 보낼 때 UTF-8 인코딩하여 데이터를 보낸다.  
 *    => {41,42,43,30,31,32,EA,B0,80,EA,B0,81,EA,B0,84}
 * 3) 톰캣 서버 8.0부터는 자동으로 UTF-16으로 인코딩함.
 *    => {0041,0042,0043,0030,0031,0032,ac00,ac01,ac04}
 *    주의!
 *    -----------------------------------------------------------------------
 *    톰캣 서버 7.x 이하에서는 반드시 server.xml 설정파일의 Connector 태그에
